/**
 * 为 copernicus_glo30 的 .terrain 文件添加 Cesium 标准头。
 * CesiumTerrainProvider 需要此 4 字节头部来解析 heightmap-1.0 格式。
...
console.log('🔧 修复 copernicus_glo30 terrain 文件 — 添加 Cesium 标准头...');
walkDir(TERRAIN_DIR);
console.log(`✅ 完成: ${fixed} 个修复 (添加头), ${skipped} 个已有头`);
