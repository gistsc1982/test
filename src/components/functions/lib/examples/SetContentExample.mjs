...
var $ = /*#__PURE__*/ w(K, [["render", Q], ["__scopeId", "data-v-9092d2be"]]), ee = {
...
function ne(e, t, n, r, o, s) {
	return y((d(), i("div", te, [...t[0] ||= [a("div", { class: "loading-message" }, "正在初始化双画布查看器（MJS模式）...", -1)]], 512)), [[_, !n.isClosed]]);
}
//#endregion
//#region ../../GISBIM/cesiumBase/src/components/functions/examples/SetContentExample.vue
var re = {
	name: "SetContentExample",
	components: {
		TestPanelModule: $,
		SetContentMjsExampleContent: /* @__PURE__ */ w(ee, [["render", ne], ["__scopeId", "data-v-dcb4a3c3"]])
	},
	data() {
...
var ae = /*#__PURE__*/ w(re, [["render", ie], ["__scopeId", "data-v-30d5afca"]]);
//#endregion
