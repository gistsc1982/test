...
typeof window < "u" && (document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", () => {
	T.init();
}) : T.init(), window.__cesiumEventManager__ = T);
//#endregion
...
var B = /*#__PURE__*/ E(ne, [["render", z], ["__scopeId", "data-v-934fcccf"]]), V = {
...
var J = /*#__PURE__*/ E(V, [["render", q], ["__scopeId", "data-v-38491e14"]]), Y = {
