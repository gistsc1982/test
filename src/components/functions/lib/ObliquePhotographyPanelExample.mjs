import { Fragment as e, Teleport as t, Transition as n, createBlock as r, createCommentVNode as i, createElementBlock as a, createElementVNode as o, createTextVNode as s, createVNode as c, normalizeClass as l, normalizeStyle as u, openBlock as d, renderList as f, renderSlot as p, resolveComponent as m, toDisplayString as h, vModelDynamic as g, vModelSelect as _, vModelText as v, vShow as y, withCtx as b, withDirectives as x, withKeys as S, withModifiers as C } from "vue";
var w = new class {
	constructor() {
...
typeof window < "u" && (document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", () => {
	w.init();
}) : w.init(), window.__cesiumEventManager__ = w);
//#endregion
...
var k = /*#__PURE__*/ T(E, [["render", O]]), A = new class {
	constructor() {
...
}, ee = { class: "header-left" }, te = { class: "panel-title" }, M = { class: "header-controls" }, N = ["aria-label"], P = {
	width: "14",
	height: "14",
	viewBox: "0 0 14 14",
	fill: "none"
...
function V(e, s, f, m, g, _) {
	return d(), r(t, { to: "body" }, [c(n, { name: "panel-fade" }, {
		...
		}, [o("div", ee, [s[5] ||= o("div", { class: "drag-indicator" }, [
			o("span", { class: "grip-dot" }),
			o("span", { class: "grip-dot" }),
			o("span", { class: "grip-dot" })
		], -1), p(e.$slots, "header", {}, () => [o("h3", te, h(f.title), 1)], !0)]), o("div", M, [f.allowMinimize ? (d(), a("button", {
			key: 0,
			onClick: s[0] ||= C((...e) => _.toggleMinimize && _.toggleMinimize(...e), ["stop"]),
			class: "icon-btn minimize-btn",
			type: "button",
			"aria-label": g.isMinimized ? "展开" : "最小化"
		}, [(d(), a("svg", P, [g.isMinimized ? (d(), a("path", I)) : (d(), a("path", F))]))], 8, N)) : i("", !0), o("button", {
			onClick: s[1] ||= C((...e) => _.close && _.close(...e), ["stop"]),
		...
		default: b(() => [!g.isClosed && g.isMinimized ? (d(), a("button", {
			...
			title: f.title
		}, [o("span", z, h(f.titleIcon || "⚙️"), 1), o("span", B, h(f.title), 1)], 12, R)) : i("", !0)]),
		_: 1
	})]);
}
var H = /*#__PURE__*/ T(j, [["render", V], ["__scopeId", "data-v-934fcccf"]]), U = new class {
	constructor() {
	...
	mounted() {
		let e = A.getPanelState(this.effectivePanelName);
	...
	beforeUnmount() {
		...
		e && (this.panelInstanceId === null ? (A.savePanelState(this.effectiveRegistrationKey, {
			cesiumObjects: e,
	...
	methods: {
		...
		onLazyLoad(e) {
			...
			t ? typeof window < "u" && window.__multiInstancePanelConfigManager__ && typeof window.__multiInstancePanelConfigManager__.getPanelInstanceCache == "function" && (n = window.__multiInstancePanelConfigManager__.getPanelInstanceCache(this.instanceId || 1, this.effectiveRegistrationKey, this.panelInstanceId)) : n = A.getPanelState(this.effectiveRegistrationKey), console.log(`[${this.panelName}] 🔍 缓存状态:`, {
				hasCache: !!n,
				...
				let e = A.getPanelState(this.effectiveRegistrationKey);
		...
		async refreshConfig(e = !0) {
			e ? (console.log(`[${this.panelName}] 🔄 强制刷新配置 (绕过缓存)`), this.configList = [], this.panelInstanceId === null ? (A.savePanelState(this.effectiveRegistrationKey, {
				cesiumObjects: {
		...
		handleClose() {
			...
			if (console.log(`[${this.panelName}] 🔍 面板模式检查:`, {
				...
				if (console.log(`[${this.panelName}] 🔍 Cesium 对象检查:`, { hasCesiumObjects: !!e }), e) {
					A.savePanelState(this.effectiveRegistrationKey, {
						cesiumObjects: e,
						configList: this.configList.map((e) => ({
							id: e.id,
							name: e.name,
					...
					let t = A.getPanelState(this.effectiveRegistrationKey);
...
}, we = ["onClick"], Te = { class: "file-name" }, Ee = { class: "files" }, De = { class: "section-title" }, Oe = {
	key: 0,
	class: "loading-text"
}, ke = ["onClick"], Ae = { class: "file-name" }, je = { class: "file-size" }, Me = {
	key: 0,
	class: "empty-message"
}, Ne = { class: "dialog-footer" }, Pe = ["disabled"];
function Fe(u, y, w, T, E, D) {
	let O = m("FunctionPanelUIBase");
	return d(), r(O, {
		ref: "basePanel",
		title: w.panelTitle,
		"title-icon": w.panelIcon,
		width: w.panelWidth,
		"max-height": w.panelMaxHeight,
		"initial-x": w.initialX,
		"initial-y": w.initialY,
		"allow-minimize": !0,
		"close-event-name": w.closeEventName,
		"auto-register": w.autoRegister !== !1,
		"registration-key": D.effectiveRegistrationKey,
		"panel-instance-id": w.panelInstanceId,
		"lazy-load": w.lazyLoad || D.getConfigLazyLoad(),
		onClose: D.handleClose,
		onMinimize: D.handleMinimize,
		onExpand: D.handleExpand,
		onLazyLoad: D.onLazyLoad
	}, {
		default: b(() => [
			o("div", G, [
				w.toolbarButtons.add ? (d(), a("button", {
					key: 0,
					onClick: y[0] ||= (...e) => D.openAddDialog && D.openAddDialog(...e),
				...
				w.toolbarButtons.export ? (d(), a("button", {
					key: 1,
					onClick: y[1] ||= (...e) => D.exportConfig && D.exportConfig(...e),
				...
				w.toolbarButtons.import ? (d(), a("button", {
					key: 2,
					onClick: y[2] ||= (...e) => D.openImportDialog && D.openImportDialog(...e),
				...
				w.toolbarButtons.refresh ? (d(), a("button", {
					key: 3,
					onClick: y[3] ||= (...e) => D.refreshConfig && D.refreshConfig(...e),
			...
			o("div", K, [(d(!0), a(e, null, f(E.configList, (e) => (d(), a("div", {
				key: e[w.itemKeyField],
				class: l(["config-item", D.getItemClass(e)])
			}, [o("div", q, [p(u.$slots, "list-item", { item: e }, () => [o("div", J, [o("span", Y, h(D.getItemDisplayName(e)), 1), o("span", X, h(D.getItemDetailText(e)), 1)])], !0)]), o("div", Z, [
				p(u.$slots, "item-actions", { item: e }, void 0, !0),
				o("button", {
					onClick: (t) => D.openEditDialog(e),
					class: "action-btn edit-btn",
					type: "button",
					"aria-label": `编辑 ${D.getItemDisplayName(e)}`,
					title: "编辑"
				}, [...y[26] ||= [o("svg", {
					viewBox: "0 0 24 24",
					fill: "none",
				...
				o("button", {
					onClick: (t) => D.confirmDelete(e),
					class: "action-btn delete-btn",
					type: "button",
					"aria-label": `删除 ${D.getItemDisplayName(e)}`,
					title: "删除"
				}, [...y[27] ||= [o("svg", {
					viewBox: "0 0 24 24",
					fill: "none",
			...
			(d(), r(t, { to: "body" }, [c(n, { name: "dialog-fade" }, {
				default: b(() => [E.showAddDialog || E.showEditDialog ? (d(), a("div", {
					key: 0,
					class: "dialog-overlay",
					onClick: y[9] ||= (...e) => D.closeDialog && D.closeDialog(...e)
				}, [o("div", {
					class: "dialog",
					onClick: y[8] ||= C(() => {}, ["stop"])
				}, [
					o("div", re, [o("h3", null, h(E.showEditDialog ? "编辑配置" : "添加配置"), 1), o("button", {
						onClick: y[4] ||= (...e) => D.closeDialog && D.closeDialog(...e),
						class: "close-btn"
					}, "×")]),
					o("div", ie, [p(u.$slots, "form-extra", { item: E.editingItem }, void 0, !0), o("div", ae, [(d(!0), a(e, null, f(w.fieldDefinitions, (t) => (d(), a("div", {
						key: t.key,
						class: "form-field"
					}, [o("label", { class: l({ required: t.required }) }, h(t.label), 3), t.type === "text" || t.type === "url" ? x((d(), a("input", {
						key: 0,
						"onUpdate:modelValue": (e) => E.formData[t.key] = e,
						type: t.type === "url" ? "url" : "text",
						placeholder: t.placeholder || `请输入${t.label}`,
						onKeydown: y[5] ||= S((...e) => D.submitForm && D.submitForm(...e), ["enter"])
					}, null, 40, oe)), [[g, E.formData[t.key]]]) : t.type === "textarea" ? x((d(), a("textarea", {
						key: 1,
						"onUpdate:modelValue": (e) => E.formData[t.key] = e,
						placeholder: t.placeholder || `请输入${t.label}`,
						rows: "3"
					}, null, 8, se)), [[v, E.formData[t.key]]]) : t.type === "select" ? x((d(), a("select", {
						key: 2,
						"onUpdate:modelValue": (e) => E.formData[t.key] = e
					}, [y[28] ||= o("option", { value: "" }, "请选择", -1), (d(!0), a(e, null, f(t.options, (e) => (d(), a("option", {
						key: e.value,
						value: e.value
					}, h(e.label), 9, le))), 128))], 8, ce)), [[_, E.formData[t.key]]]) : i("", !0)]))), 128))])]),
					o("div", ue, [o("button", {
						onClick: y[6] ||= (...e) => D.closeDialog && D.closeDialog(...e),
						class: "btn cancel-btn"
					}, "取消"), o("button", {
						onClick: y[7] ||= (...e) => D.submitForm && D.submitForm(...e),
			...
			(d(), r(t, { to: "body" }, [c(n, { name: "dialog-fade" }, {
				default: b(() => [E.showDeleteDialog ? (d(), a("div", {
					key: 0,
					class: "dialog-overlay",
					onClick: y[14] ||= (e) => E.showDeleteDialog = !1
				}, [o("div", {
					class: "dialog dialog-small",
					onClick: y[13] ||= C(() => {}, ["stop"])
				}, [
					o("div", de, [y[29] ||= o("h3", null, "确认删除", -1), o("button", {
						onClick: y[10] ||= (e) => E.showDeleteDialog = !1,
						class: "close-btn"
					}, "×")]),
					o("div", fe, [o("div", pe, [y[30] ||= o("svg", {
						class: "warning-icon",
						viewBox: "0 0 24 24",
						fill: "currentColor"
					}, [o("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" })], -1), o("span", me, [s(" 确定要删除 \"" + h(E.deleteTarget ? D.getItemDisplayName(E.deleteTarget) : "") + "\" 吗？ ", 1), p(u.$slots, "delete-warning-extra", { item: E.deleteTarget }, void 0, !0)])])]),
					o("div", he, [o("button", {
						onClick: y[11] ||= (e) => E.showDeleteDialog = !1,
						class: "btn cancel-btn"
					}, "取消"), o("button", {
						onClick: y[12] ||= (...e) => D.executeDelete && D.executeDelete(...e),
			...
			(d(), r(t, { to: "body" }, [c(n, { name: "dialog-fade" }, {
				default: b(() => [E.showImportDialog ? (d(), a("div", {
					key: 0,
					class: "dialog-overlay dialog-large",
					onClick: y[21] ||= (...e) => D.closeImportDialog && D.closeImportDialog(...e)
				}, [o("div", {
					class: "dialog dialog-large",
					onClick: y[20] ||= C(() => {}, ["stop"])
				}, [
					o("div", ge, [y[31] ||= o("h3", null, "从服务器导入配置", -1), o("button", {
						onClick: y[15] ||= (...e) => D.closeImportDialog && D.closeImportDialog(...e),
						class: "close-btn"
					}, "×")]),
					o("div", _e, [o("div", ve, [
						o("div", ye, [
							o("button", {
								onClick: y[16] ||= (...e) => D.navigateToRoot && D.navigateToRoot(...e),
								class: "nav-btn",
								disabled: E.loadingServerFiles
							}, [...y[32] ||= [o("svg", {
								viewBox: "0 0 24 24",
								fill: "none",
								stroke: "currentColor",
							...
							o("button", {
								onClick: y[17] ||= (...e) => D.navigateToParentDirectory && D.navigateToParentDirectory(...e),
								class: "nav-btn",
								disabled: !D.canGoBack || E.loadingServerFiles
							}, [...y[33] ||= [o("svg", {
								viewBox: "0 0 24 24",
								fill: "none",
								stroke: "currentColor",
							...
							o("span", Se, "当前：" + h(D.currentDirectoryDisplay), 1)
						]),
						D.currentSubdirectories.length > 0 ? (d(), a("div", Ce, [y[36] ||= o("div", { class: "section-title" }, "子目录", -1), (d(!0), a(e, null, f(D.currentSubdirectories, (e) => (d(), a("div", {
							key: e,
							onClick: (t) => D.navigateToDirectory(e),
						...
						o("div", Ee, [
							o("div", De, [y[37] ||= s(" 配置文件 ", -1), E.loadingServerFiles ? (d(), a("span", Oe, "加载中...")) : i("", !0)]),
							(d(!0), a(e, null, f(D.currentDirectoryFiles, (e) => (d(), a("div", {
								key: e.filePath,
								onClick: (t) => D.selectFile(e),
								class: l(["file-item", { selected: E.selectedServerFile === e }])
							}, [
								y[38] ||= o("svg", {
									class: "file-icon",
									viewBox: "0 0 24 24",
								...
								o("span", Ae, h(e.fileName), 1),
								o("span", je, h(D.formatFileSize(e.fileSize)), 1)
							], 10, ke))), 128)),
							D.currentDirectoryFiles.length === 0 && !E.loadingServerFiles ? (d(), a("div", Me, " 此目录下没有配置文件 ")) : i("", !0)
						])
					])]),
					o("div", Ne, [o("button", {
						onClick: y[18] ||= (...e) => D.closeImportDialog && D.closeImportDialog(...e),
						class: "btn cancel-btn"
					}, "取消"), o("button", {
						onClick: y[19] ||= (...e) => D.importConfig && D.importConfig(...e),
						class: "btn confirm-btn",
						disabled: !E.selectedServerFile
					}, " 导入 ", 8, Pe)])
				])])) : i("", !0)]),
				_: 1
			})])),
...
var Ie = /*#__PURE__*/ T(W, [["render", Fe], ["__scopeId", "data-v-2c60153e"]]), Le = {
...
}, ze = { class: "banner-content" }, Be = { class: "banner-text" }, Ve = { class: "banner-suggestion" }, He = { class: "highlight" }, Ue = ["disabled"], We = { class: "current-height-card" }, Ge = { class: "height-value" }, Ke = { class: "value" }, qe = { class: "adjustment-section" }, Je = { class: "slider-container" }, Ye = ["value"], Xe = { class: "precise-input-section" }, Ze = { class: "input-group" }, Qe = ["value"], $e = { class: "preset-section" }, et = { class: "preset-grid" }, tt = ["onClick"], $ = {
	key: 1,
	class: "empty-state"
};
function nt(t, n, c, u, p, g) {
	...
	return d(), r(_, {
		...
		default: b(() => [c.selectedLayer ? (d(), a(e, { key: 0 }, [
			c.selectedLayer.loaded && c.selectedLayer.recommendedOffset !== void 0 && c.selectedLayer.recommendedOffset !== null ? (d(), a("div", Re, [o("div", ze, [
				n[8] ||= o("svg", {
					class: "banner-icon",
					viewBox: "0 0 24 24",
					fill: "none",
				...
				o("div", Be, [n[7] ||= o("div", { class: "banner-main" }, "检测到倾斜摄影地形高度较低", -1), o("div", Ve, [
					n[5] ||= s(" 建议向上偏移 ", -1),
					o("span", He, h(c.selectedLayer.recommendedOffset.toFixed(1)) + " 米", 1),
					n[6] ||= s(" 以与大坐标模型底部对齐 ", -1)
				])]),
				o("button", {
				...
				}, h(Math.abs(c.selectedLayer.heightOffset - c.selectedLayer.recommendedOffset) < .1 ? "已应用" : "应用推荐值"), 9, Ue)
			])])) : i("", !0),
			o("div", We, [n[10] ||= o("div", { class: "card-header" }, [o("h4", { class: "card-title" }, "当前高度偏移"), o("span", {
				class: "hint-icon",
				...
				"stroke-linecap": "round"
			})])])], -1), o("div", Ge, [o("span", Ke, h((c.selectedLayer.heightOffset || 0).toFixed(2)), 1), n[9] ||= o("span", { class: "unit" }, "米", -1)])]),
			o("div", qe, [
				...
				o("div", Je, [o("input", {
					...
					class: "height-slider"
				}, null, 40, Ye), n[11] ||= o("div", { class: "slider-track-fill" }, null, -1)]),
				n[13] ||= o("div", { class: "usage-hint" }, "调整后使倾斜摄影与大坐标模型高度对齐", -1)
			]),
			o("div", Xe, [n[15] ||= o("label", { class: "input-label" }, "精确设置偏移（米）", -1), o("div", Ze, [o("input", {
				type: "number",
				value: c.selectedLayer.heightOffset || 0,
			...
			o("div", $e, [n[16] ||= o("div", { class: "section-label" }, "快捷预设", -1), o("div", et, [(d(!0), a(e, null, f(p.presets, (e) => (d(), a("button", {
				key: e.value,
				onClick: (t) => g.applyPreset(e.value),
				class: l(["preset-btn", { active: Math.abs(c.selectedLayer.heightOffset - e.value) < .1 }])
			}, h(e.label), 11, tt))), 128))])])
		], 64)) : (d(), a("div", $, [...n[17] ||= [o("svg", {
			class: "empty-icon",
			viewBox: "0 0 24 24",
			fill: "none",
			stroke: "currentColor",
...
var rt = {
	...
	components: {
		JsonConfigPanelBase: Ie,
		ObliqueHeightAdjustPanel: /* @__PURE__ */ T(Le, [["render", nt], ["__scopeId", "data-v-80456ab5"]])
	},
	props: {
		initialX: {
			type: [Number, String],
...
}, it = { class: "oblique-checkbox" }, at = [
	"checked",
	"onChange",
	"disabled"
], ot = { class: "item-info" }, st = { class: "item-name" }, ct = {
	key: 0,
	class: "loading-text"
}, lt = {
	key: 1,
...
}, dt = ["onClick", "disabled"], ft = ["onClick"], pt = {
	key: 0,
...
function ht(e, l, u, f, p, g) {
	...
	return d(), r(v, {
		...
		"list-item": b(({ item: e }) => [o("label", it, [
			...
			o("div", ot, [o("span", st, h(e.name || "未知"), 1), e.loading ? (d(), a("span", ct, "加载中...")) : e.loaded ? (d(), a("span", lt, "已加载")) : (d(), a("span", ut, "未加载"))])
		])]),
		...
		"delete-warning-extra": b(({ item: e }) => [e.loaded ? (d(), a("div", pt, " ⚠️ 该项目当前已加载，请先卸载再删除 ")) : i("", !0)]),
		dialogs: b(() => [(d(), r(t, { to: "body" }, [c(n, { name: "height-panel-fade" }, {
			default: b(() => [p.showHeightPanel && p.selectedLayer ? (d(), a("div", mt, [c(_, {
...
var gt = /*#__PURE__*/ T(rt, [["render", ht], ["__scopeId", "data-v-2696f1a5"]]);
//#endregion
