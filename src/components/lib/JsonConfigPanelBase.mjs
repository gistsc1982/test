...
var A = /*#__PURE__*/ E(D, [["render", k]]), te = class {
	constructor() {
...
function K(e, s, f, ee, h, g) {
	return d(), r(t, { to: "body" }, [
		c(n, { name: "panel-fade" }, {
			default: y(() => [h.isClosed ? i("v-if", !0) : (d(), a("div", {
				key: 0,
				...
				o("div", {
					...
					o("span", { class: "grip-dot" }),
					o("span", { class: "grip-dot" })
				], -1), p(e.$slots, "header", {}, () => [o("h3", I, m(f.title), 1)], !0)]), o("div", L, [f.allowMinimize ? (d(), a("button", {
					key: 0,
					onClick: s[0] ||= S((...e) => g.toggleMinimize && g.toggleMinimize(...e), ["stop"]),
					class: "icon-btn minimize-btn",
					type: "button",
					"aria-label": h.isMinimized ? "展开" : "最小化"
				}, [(d(), a("svg", z, [h.isMinimized ? (d(), a("path", V)) : (d(), a("path", B))]))], 8, R)) : i("v-if", !0), o("button", {
					onClick: s[1] ||= S((...e) => g.close && g.close(...e), ["stop"]),
				...
				c(n, {
					...
					default: y(() => [b(o("div", {
						...
						sectionVisible: g.sectionVisible,
						toggleSection: g.toggleSection
		...
		i(" 最小化时的浮动按钮 "),
		c(n, { name: "fab-fade" }, {
			default: y(() => [!h.isClosed && h.isMinimized ? (d(), a("button", {
				key: 0,
				class: "panel-fab",
				type: "button",
				style: u(g.fabStyles),
				...
				title: f.title
			}, [o("span", W, m(f.titleIcon || "⚙️"), 1), o("span", G, m(f.title), 1)], 12, U)) : i("v-if", !0)]),
			_: 1
		})
	]);
}
var q = /*#__PURE__*/ E(P, [["render", K], ["__scopeId", "data-v-35108af7"]]), J = new class {
	constructor() {
...
}(), Y = typeof window < "u" && window.__panelSingletonManager__ || M, X = {
...
}, $ = ["onClick"], Fe = { class: "file-name" }, Ie = { class: "files" }, Le = { class: "section-title" }, Re = {
	key: 0,
	class: "loading-text"
}, ze = ["onClick"], Be = { class: "file-name" }, Ve = { class: "file-size" }, He = {
	key: 0,
	class: "empty-message"
}, Ue = { class: "dialog-footer" }, We = ["disabled"];
function Ge(u, v, C, w, T, E) {
	let D = ee("FunctionPanelUIBase");
	return d(), a(e, null, [i(" 主面板 "), c(D, {
		...
		header: y(() => [p(u.$slots, "header", {}, () => [o("h3", Z, m(C.panelTitle), 1), (d(!0), a(e, null, f(C.headerTools, (e) => (d(), a("button", {
			key: e.key,
			...
			key: 0,
			innerHTML: e.icon
		}, null, 8, ne)) : i("v-if", !0), o("span", null, m(e.label), 1)], 10, Q))), 128))], !0)]),
		default: y(() => [
			o("div", re, [
				i(" 添加按钮 "),
				C.toolbarButtons.add ? (d(), a("button", {
					key: 0,
					onClick: v[0] ||= (...e) => E.openAddDialog && E.openAddDialog(...e),
				...
				C.toolbarButtons.export ? (d(), a("button", {
					key: 1,
					onClick: v[1] ||= (...e) => E.exportConfig && E.exportConfig(...e),
				...
				C.toolbarButtons.import ? (d(), a("button", {
					key: 2,
					onClick: v[2] ||= (...e) => E.openImportDialog && E.openImportDialog(...e),
				...
				C.toolbarButtons.refresh ? (d(), a("button", {
					key: 3,
					onClick: v[3] ||= (...e) => E.refreshConfig && E.refreshConfig(...e),
				...
				(d(!0), a(e, null, f(C.sectionToggles, (e) => (d(), a("button", {
					...
					key: 0,
					innerHTML: e.icon
				}, null, 8, ae)) : i("v-if", !0), o("span", null, m(e.label), 1)], 10, ie))), 128)),
				i(" 子类扩展：工具栏额外按钮 "),
			...
			o("div", oe, [(d(!0), a(e, null, f(T.configList, (e) => (d(), a("div", {
				...
				i(" 列表项主体 "),
				o("div", se, [i(" 子类扩展：列表项内容 "), p(u.$slots, "list-item", { item: e }, () => [i(" 默认内容：显示字段值 "), o("div", ce, [o("span", le, m(E.getItemDisplayName(e)), 1), o("span", ue, m(E.getItemDetailText(e)), 1)])], !0)]),
				i(" 操作按钮组 "),
				o("div", de, [
					i(" 子类扩展：额外操作按钮 "),
			...
			(d(), r(t, { to: "body" }, [c(n, { name: "dialog-fade" }, {
				default: y(() => [T.showAddDialog || T.showEditDialog ? (d(), a("div", {
					key: 0,
					class: "dialog-overlay",
					onClick: v[9] ||= (...e) => E.closeDialog && E.closeDialog(...e)
				}, [o("div", {
					class: "dialog",
					onClick: v[8] ||= S(() => {}, ["stop"])
				}, [
					o("div", me, [o("h3", null, m(T.showEditDialog ? "编辑配置" : "添加配置"), 1), o("button", {
						onClick: v[4] ||= (...e) => E.closeDialog && E.closeDialog(...e),
						class: "close-btn"
					}, "×")]),
					o("div", he, [
						i(" 子类扩展：表单额外内容 "),
						...
						o("div", ge, [(d(!0), a(e, null, f(C.fieldDefinitions, (t) => (d(), a("div", {
							key: t.key,
							class: "form-field"
						}, [o("label", { class: l({ required: t.required }) }, m(t.label), 3), t.type === "text" || t.type === "url" ? b((d(), a("input", {
							key: 0,
							"onUpdate:modelValue": (e) => T.formData[t.key] = e,
							type: t.type === "url" ? "url" : "text",
							placeholder: t.placeholder || `请输入${t.label}`,
							onKeydown: v[5] ||= x((...e) => E.submitForm && E.submitForm(...e), ["enter"])
						}, null, 40, _e)), [[h, T.formData[t.key]]]) : t.type === "textarea" ? b((d(), a("textarea", {
							key: 1,
							"onUpdate:modelValue": (e) => T.formData[t.key] = e,
							placeholder: t.placeholder || `请输入${t.label}`,
							rows: "3"
						}, null, 8, ve)), [[_, T.formData[t.key]]]) : t.type === "select" ? b((d(), a("select", {
							key: 2,
							"onUpdate:modelValue": (e) => T.formData[t.key] = e
						}, [v[28] ||= o("option", { value: "" }, "请选择", -1), (d(!0), a(e, null, f(t.options, (e) => (d(), a("option", {
							key: e.value,
							value: e.value
						}, m(e.label), 9, be))), 128))], 8, ye)), [[g, T.formData[t.key]]]) : i("v-if", !0)]))), 128))])
					]),
					o("div", xe, [o("button", {
						onClick: v[6] ||= (...e) => E.closeDialog && E.closeDialog(...e),
						class: "btn cancel-btn"
					}, "取消"), o("button", {
						onClick: v[7] ||= (...e) => E.submitForm && E.submitForm(...e),
			...
			(d(), r(t, { to: "body" }, [c(n, { name: "dialog-fade" }, {
				default: y(() => [T.showDeleteDialog ? (d(), a("div", {
					key: 0,
					class: "dialog-overlay",
					onClick: v[14] ||= (e) => T.showDeleteDialog = !1
				}, [o("div", {
					class: "dialog dialog-small",
					onClick: v[13] ||= S(() => {}, ["stop"])
				}, [
					o("div", Se, [v[29] ||= o("h3", null, "确认删除", -1), o("button", {
						onClick: v[10] ||= (e) => T.showDeleteDialog = !1,
						class: "close-btn"
					}, "×")]),
					o("div", Ce, [o("div", we, [v[30] ||= o("svg", {
						class: "warning-icon",
						viewBox: "0 0 24 24",
						fill: "currentColor"
					}, [o("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" })], -1), o("span", Te, [s(" 确定要删除 \"" + m(T.deleteTarget ? E.getItemDisplayName(T.deleteTarget) : "") + "\" 吗？ ", 1), p(u.$slots, "delete-warning-extra", { item: T.deleteTarget }, void 0, !0)])])]),
					o("div", Ee, [o("button", {
						onClick: v[11] ||= (e) => T.showDeleteDialog = !1,
						class: "btn cancel-btn"
					}, "取消"), o("button", {
						onClick: v[12] ||= (...e) => E.executeDelete && E.executeDelete(...e),
			...
			(d(), r(t, { to: "body" }, [c(n, { name: "dialog-fade" }, {
				default: y(() => [T.showImportDialog ? (d(), a("div", {
					key: 0,
					class: "dialog-overlay dialog-large",
					onClick: v[21] ||= (...e) => E.closeImportDialog && E.closeImportDialog(...e)
				}, [o("div", {
					class: "dialog dialog-large",
					onClick: v[20] ||= S(() => {}, ["stop"])
				}, [
					o("div", De, [v[31] ||= o("h3", null, "从服务器导入配置", -1), o("button", {
						onClick: v[15] ||= (...e) => E.closeImportDialog && E.closeImportDialog(...e),
						class: "close-btn"
					}, "×")]),
					o("div", Oe, [i(" 目录导航 "), o("div", ke, [
						o("div", Ae, [
							o("button", {
								onClick: v[16] ||= (...e) => E.navigateToRoot && E.navigateToRoot(...e),
								class: "nav-btn",
							...
							o("button", {
								onClick: v[17] ||= (...e) => E.navigateToParentDirectory && E.navigateToParentDirectory(...e),
								class: "nav-btn",
							...
							o("span", Ne, "当前：" + m(E.currentDirectoryDisplay), 1)
						]),
						i(" 子目录列表 "),
						E.currentSubdirectories.length > 0 ? (d(), a("div", Pe, [v[36] ||= o("div", { class: "section-title" }, "子目录", -1), (d(!0), a(e, null, f(E.currentSubdirectories, (e) => (d(), a("div", {
							key: e,
						...
						i(" 文件列表 "),
						o("div", Ie, [
							o("div", Le, [v[37] ||= s(" 配置文件 ", -1), T.loadingServerFiles ? (d(), a("span", Re, "加载中...")) : i("v-if", !0)]),
							(d(!0), a(e, null, f(E.currentDirectoryFiles, (e) => (d(), a("div", {
								...
								o("span", Be, m(e.fileName), 1),
								o("span", Ve, m(E.formatFileSize(e.fileSize)), 1)
							], 10, ze))), 128)),
							E.currentDirectoryFiles.length === 0 && !T.loadingServerFiles ? (d(), a("div", He, " 此目录下没有配置文件 ")) : i("v-if", !0)
						])
					])]),
					o("div", Ue, [o("button", {
						onClick: v[18] ||= (...e) => E.closeImportDialog && E.closeImportDialog(...e),
						class: "btn cancel-btn"
					}, "取消"), o("button", {
						onClick: v[19] ||= (...e) => E.importConfig && E.importConfig(...e),
						class: "btn confirm-btn",
...
var Ke = /*#__PURE__*/ E(X, [["render", Ge], ["__scopeId", "data-v-4e702488"]]);
//#endregion
